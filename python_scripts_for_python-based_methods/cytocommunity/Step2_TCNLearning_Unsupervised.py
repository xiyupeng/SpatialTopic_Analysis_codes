...
## Hyperparameters
InputFolderName = "./nanostring_lung/"
Image_Name = "image1"
Num_TCN = 7
Num_Run = 10       ## change from the default 20
Num_Epoch = 100  ## change from default 3000
Embedding_Dimension = 128
Learning_Rate = 0.0001
Loss_Cutoff = -0.6   ## change from the default -0.2
...
ThisStep_OutputFolderName = "./Step2_Output_" + Image_Name + "_v2/"
