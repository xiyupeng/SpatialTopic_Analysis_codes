...
topic<-paste0("topic",apply(tw_spatial_lda,1,which.max))
...
ImageDimPlot(nano.obj, fov = "lung5.rep1", group.by = "domain_BankSY", axes = FALSE, 
                           dark.background = F,cols = "glasbey") + ggtitle("BankSY")
...
ImageDimPlot(nano.obj, fov = "lung5.rep1", group.by = "utag_domain",axes = FALSE, 
                           dark.background = F,cols = "glasbey") + ggtitle("UTAG")
ImageDimPlot(nano.obj, fov = "lung5.rep1", group.by = "CytoCommunity", axes = FALSE,  
                           dark.background = F,cols = "glasbey") + ggtitle("CytoCommunity")
```
...
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5,cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "Topic")+NoLegend()+ggtitle("SpatialTopic")
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "niches")+NoLegend()+ggtitle("Seurat v5")
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "domain_BankSY")+NoLegend()+ ggtitle("BankSY")
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "topic_spatial_LDA")+NoLegend()+ ggtitle("Spatial-LDA")
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "utag_domain")+NoLegend()+ ggtitle("UTAG")
ImageDimPlot(nano.obj, fov = "zoom1", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "CytoCommunity")+NoLegend()+ggtitle("CytoCommunity")
```
...
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5,cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "Topic")+NoLegend()+ggtitle("SpatialTopic")
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "niches")+NoLegend()+ggtitle("Seurat v5")
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "domain_BankSY")+NoLegend()+ ggtitle("BankSY")
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "topic_spatial_LDA")+NoLegend()+ ggtitle("Spatial-LDA")
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "utag_domain")+NoLegend()+ ggtitle("UTAG")
ImageDimPlot(nano.obj, fov = "zoom1b", size = 1.5, cols = "glasbey", dark.background = F,coord.fixed = FALSE,group.by = "CytoCommunity")+NoLegend()+ggtitle("CytoCommunity")
```
